...
export const routePermissions: RoutePermission[] = [
  ...
  { pattern: /^\/api\/application-logic-readiness$/, methods: ["GET"], permission: "report:read" },
  { pattern: /^\/api\/kb-planner-foundation$/, methods: ["GET"], permission: "report:read" },
  ...
  { pattern: /^\/api\/production-reality$/, methods: ["GET"], permission: "report:read" },
